...
import code = require("./asttools")
import fs = require("fs");
import util = require("util");

function percentDifference(v1:number,v2:number)
{
...
function test(js1: string | Buffer, js2: string | Buffer) {
    let tree1 = parser.parse(js1);
    let tree2 = parser.parse(js2);
